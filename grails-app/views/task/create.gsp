                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="dayOfMonth"><g:message code="task.dayOfMonth.label" default="Day Of Month" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="dayOfWeek"><g:message code="task.dayOfWeek.label" default="Day Of Week" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="dayOfYear"><g:message code="task.dayOfYear.label" default="Day Of Year" /></label>
                                </td>
