...
<%@ page import="fi.cleanit.domain.User" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.doneTasks.label" default="Done Tasks" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${userInstance.doneTasks}" var="d">
                                    <li><g:link controller="activeTask" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.family.label" default="Family" /></td>
                            
                            <td valign="top" class="value"><g:link controller="family" action="show" id="${userInstance?.family?.id}">${userInstance?.family?.encodeAsHTML()}</g:link></td>
